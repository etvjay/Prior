...
async function estimateSelectedForkGas(args: { block: bigint; observationTimestamp: bigint; marketId: string; circuitId: string; trialId: string; registry: string; executor: string; marketClass: number; startsAt: bigint; expiresAt: bigint }): Promise<any> {
