...
assert.doesNotMatch(source, /window\.ethereum|eth_requestAccounts|eth_sendTransaction|wallet_switchEthereumChain/);
assert.match(source, /useAccount/);
assert.match(source, /usePublicClient/);
assert.match(source, /useWalletClient/);
assert.match(source, /sendTransaction/);
assert.match(source, /waitForTransactionReceipt/);
assert.match(source, /RainbowKitProvider/);
assert.match(source, /useConnectModal/);
assert.match(source, /wagmiConfig/);
assert.match(source, /injectedWallet/);
