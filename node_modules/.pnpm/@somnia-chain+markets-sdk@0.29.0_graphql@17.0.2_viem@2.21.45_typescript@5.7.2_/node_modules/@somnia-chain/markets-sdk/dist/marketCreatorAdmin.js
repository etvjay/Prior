 ...
 */
export async function getSeries(creator, seriesId, indexerUrl) {
    const data = await IndexerRead.gqlRequest(SeriesByIdQuery, { id: `${creator.toLowerCase()}_${seriesId}` }, indexerUrl);
