import { type Abi, type Account, type Address, type Hex, type LocalAccount, type PublicClient, type WalletClient } from "viem";
import type { ClientConfig } from "./config.js";
import type { Debug } from "./debug.js";
import type { BinarySide } from "./store.js";
import type { TraderConfig, TxResult, PlaceOrderResult, PlaceOrderParams, AmendOrderResult, AmendOrdersResult } from "./trade.js";
export declare function farFutureNs(): bigint;
 ...
 * @category trading
 */
export declare const ORDER_KIND: Record<BinarySide, number>;
 ...
 * @internal
 */
export declare function toUnsigned(call: WriteCall, description: string): UnsignedCall;
/**
 ...
 * @internal
 */
export declare function approvalCall(token: Address, spender: Address, description: string): UnsignedCall;
/**
 ...
 * @internal
 */
export declare function decodeBatchAmendResult({ hash, receipt }: TxResult, { pool, amendmentCount }: {
    pool: Address;
 ...
 * @internal
 */
export declare function decodeAmendResult({ hash, receipt }: TxResult, { pool }: {
    pool: Address;
}): AmendOrderResult;
/**
 ...
 * @internal
 */
export declare function createWriter(config: TraderConfig, deps: WriterDeps): Writer;
