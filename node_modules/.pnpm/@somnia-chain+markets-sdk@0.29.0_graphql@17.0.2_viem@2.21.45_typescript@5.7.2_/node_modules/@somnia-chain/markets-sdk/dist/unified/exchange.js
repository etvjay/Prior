...
export class SomniaMarkets {
     ...
     */
    chainOnlyPerps = new Set();
    perpDiscoveryFailure = null;
    perpDiscoveryPartial = null;
    ...
    async loadMarkets(reload = false) {
        ...
        const { statuses, chainOnly, failed } = await this.discoverPerpPools(indexerRows).catch((err) => {
            ...
            return { statuses: new Map(), chainOnly: [], failed: [] };
        });
    ...
    async discoverPerpPools(indexerRows) {
        const empty = { statuses: new Map(), chainOnly: [], failed: [] };
    ...
    async synthesizePerps(missing, collateral, factory) {
        ...
        const erc20 = { address: token, abi: ReadsAbi.erc20ReadAbi };
        ...
        const collateralSymbol = collateral.symbol !== undefined
            ? collateral.symbol
            : await this.client
                .getViemClient()
                ...
                .catch((err) => {
                if (PerpRegistry.isMissingContractView(err))
                    return null;
                throw err;
            });
