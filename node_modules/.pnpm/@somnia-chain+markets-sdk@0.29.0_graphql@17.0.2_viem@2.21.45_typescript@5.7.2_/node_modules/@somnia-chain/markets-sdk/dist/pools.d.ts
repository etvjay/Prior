 ...
 */
export declare function getMarketByPool(pool: string, indexerUrl: string): Promise<Market | null>;
/**
 ...
 */
export declare function listMarketsByPool(pool: string, opts: {
    limit?: number;
 ...
 */
export declare function getPoolBindings(pool: string, indexerUrl: string): Promise<PoolBindingRecord[]>;
/**
 ...
 *  MarketCreated on it.
 */
export declare function getPool(address: string, indexerUrl: string): Promise<IndexedPool | null>;
/**
 ...
 */
export declare function getFreePools(creator: Address, collateral: Address, module: Address, client: PublicClient): Promise<Address[]>;
