 ...
 * @category markets
 */
export declare function binaryResolutionMode(strike: string | bigint | null | undefined): BinaryResolutionMode;
/**
 ...
 */
export declare function countMarketsBounded(opts: {
    marketType?: MarketType;
} | undefined, indexerUrl: string, headers?: Record<string, string>): Promise<IndexerRead.CountResult>;
/**
 ...
 *  early.
 */
export declare function countBinaryMarketsBounded(opts: BinaryMarketFilter & {
    phase: "live" | "past";
    nowSec?: number;
}, indexerUrl: string, headers?: Record<string, string>): Promise<IndexerRead.CountResult>;
/**
 ...
 * @category markets
 */
export declare function boundaryPrice(m: Pick<BinaryMarket, "id" | "strike" | "mode">, openingPrices: Record<string, string | null>): {
    raw: string;
    posted: boolean;
} | null;
/**
 ...
 */
export declare function getResolutionPrices(marketIds: string[], indexerUrl: string): Promise<Record<string, string | null>>;
/**
 ...
 */
export declare function getOnchainResolutionPrice(marketId: Hex, sources: {
    module: Address;
    fallbackDecimals?: number;
}, client: PublicClient): Promise<OnchainResolutionPrice | null>;
/**
