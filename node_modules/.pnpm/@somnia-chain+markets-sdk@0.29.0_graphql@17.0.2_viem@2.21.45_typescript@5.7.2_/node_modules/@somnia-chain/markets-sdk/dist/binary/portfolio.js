...
export async function getPortfolio(account, opts = {}, indexerUrl) {
    ...
    const data = await IndexerRead.gqlRequest(PortfolioQuery, { acct, fillWhere, ordersLimit: opts.ordersLimit ?? 200, tradesLimit }, indexerUrl);
