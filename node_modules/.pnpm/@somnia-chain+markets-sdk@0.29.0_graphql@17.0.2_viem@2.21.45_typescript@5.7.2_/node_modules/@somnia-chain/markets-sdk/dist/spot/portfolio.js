...
export async function getSpotPortfolio(account, opts = {}, indexerUrl) {
    ...
    const data = await IndexerRead.gqlRequest(SpotPortfolioQuery, { acct, fillWhere, ordersLimit: opts.ordersLimit ?? 200, tradesLimit }, indexerUrl);
