 ...
 *  (ready for charting).
 */
export declare function getCandles(poolAddress: string, intervalSeconds: number, opts: {
    limit?: number;
    from?: number;
    to?: number;
} | undefined, indexerUrl: string): Promise<Candle[]>;
/**
 ...
 * @category models
 */
export declare const CANDLE_INTERVALS: readonly [60, 300, 900, 3600, 14400, 86400];
