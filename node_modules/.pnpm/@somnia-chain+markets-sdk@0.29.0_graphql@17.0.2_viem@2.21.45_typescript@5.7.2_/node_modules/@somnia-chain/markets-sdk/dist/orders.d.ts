...
import type { AmendOrderParams, AmendOrderResult, AmendOrdersParams, AmendOrdersResult, CancelExpiredOrdersParams, CaptureCloseParams, CancelOrderParams, CancelOrdersParams, CancelOrdersResult, PlaceOrderParams, PlaceOrderResult, PlacePerpOrderParams, PlaceSpotOrderParams, PlaceSpotOrdersParams, PlaceSpotOrdersResult, ReduceOrderParams, ReduceOrdersParams, SweepExpiredAtLevelParams, TxResult } from "./trade.js";
/**
 ...
 */
export declare function getOrder(pool: string, orderId: bigint | string, indexerUrl: string): Promise<OrderDetail | null>;
/**
 ...
 */
export declare function getClosingPrice(pool: Address, client: PublicClient): Promise<ClosingPriceState | null>;
/**
...
export declare function captureClose(w: WriterCtx, p: CaptureCloseParams): Promise<TxResult>;
