...
export declare function createOperatorAdminWithDeps(config: OperatorAdminConfig, deps: OperatorAdminDeps): OperatorAdmin;
/**
 ...
 */
export declare function listOperators(opts: (OperatorFilter & {
    limit?: number;
    offset?: number;
}) | undefined, indexerUrl: string): Promise<IndexedOperator[]>;
/**
 ...
 *  below it.
 */
export declare function countOperators(opts: OperatorFilter, indexerUrl: string, headers?: Record<string, string>): Promise<number>;
/**
 *  Fetch one operator by id (null if never registered — a directory or a
 *  hand-typed id can miss).
 */
export declare function getOperator(operatorId: number, indexerUrl: string): Promise<IndexedOperator | null>;
/**
 ...
 */
export declare function listVenues(opts: {
    operatorId?: number;
    marketType?: string;
    creationEnabled?: boolean;
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<IndexedVenue[]>;
/**
 ...
 */
export declare function countVenues(opts: {
    operatorId?: number;
    marketType?: string;
}, indexerUrl: string, headers?: Record<string, string>): Promise<number>;
/** Fetch one venue by its opaque bytes32 id (null if unknown). */
export declare function getVenue(venueId: string, indexerUrl: string): Promise<IndexedVenue | null>;
