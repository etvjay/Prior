...
import type { MarketActivity, MarketActivityOptions, TransactionActivity, TransactionActivityOptions } from "./activity.js";
...
import type { MarginAccount, AccountHealth, PerpRiskParams, PerpHealthSnapshot, PerpOrderMarginPreview, PerpClosePreview, PerpLeverage, PerpLiquidationPreview, PerpMaxOrderSize, PerpPositionAnalytics, PerpSideHolders, PerpSideHoldersRef, GetPerpSideHoldersOptions, GetBankruptcyPriceOptions, GetPerpMaxLeverageOptions } from "./perp/margin.js";
import type { PerpPoolStatus } from "./perp/registry.js";
import type { PerpFundingPayer, PerpMainFunding, PerpWalletLinkage } from "./perp/linkedWallet.js";
...
export interface SomniaMarketsClient {
     ...
     */
    countBinaryMarketsBounded(opts: BinaryMarketFilter & {
        phase: "live" | "past";
        nowSec?: number;
    }): Promise<CountResult>;
    /**
     ...
     */
    getTransactionActivity(txHash: string, opts?: TransactionActivityOptions): Promise<TransactionActivity>;
    /**
     ...
     */
    getOrderFills(pool: string, orderId: bigint | string, opts?: {
        limit?: number;
     ...
     */
    listMarketsByPool(pool: string, opts?: {
        limit?: number;
    }): Promise<Market[]>;
    /**
