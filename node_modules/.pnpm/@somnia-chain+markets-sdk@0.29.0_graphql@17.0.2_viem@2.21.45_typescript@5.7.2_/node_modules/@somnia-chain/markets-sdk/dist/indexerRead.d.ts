 ...
 */
export declare function registerIndexerSignal(indexerUrl: string, signal: AbortSignal): () => void;
/**
 ...
 */
export declare function gqlRequest<TResult, TVariables extends Record<string, unknown>>(document: TypedDocument<TResult, TVariables>, variables: TVariables, indexerUrl: string, headers?: Record<string, string>): Promise<TResult>;
/**
 ...
 */
export declare function gqlRequestDynamic<T>(query: string, variables: Record<string, unknown>, indexerUrl: string, headers?: Record<string, string>): Promise<T>;
/** Row ceiling on the public-role fallback scan. Past this a count is a lower bound. */
export declare const COUNT_FALLBACK_CAP = 10000;
/**
 ...
 */
export declare function aggregateCountBounded(table: "Market" | "Operator" | "Venue" | "Order" | "Fill", whereType: string, where: Record<string, unknown>, indexerUrl: string, headers?: Record<string, string>): Promise<CountResult>;
/**
 ...
 */
export declare function aggregateCount(table: "Market" | "Operator" | "Venue" | "Order" | "Fill", whereType: string, where: Record<string, unknown>, indexerUrl: string, headers?: Record<string, string>): Promise<number>;
/**
 ...
 */
export declare function narrowIndexerInvariant<T>(rows: readonly unknown[]): T[];
