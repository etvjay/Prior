 ...
 */
export declare function getPerpPortfolio(account: string, opts: PortfolioOptions | undefined, indexerUrl: string): Promise<PerpPortfolio>;
/**
 ...
 */
export declare function listPerpOrderHistory(account: string, opts: {
    pool?: string;
    status?: TerminalOrderStatus[];
    orderBy?: "ended" | "placed";
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<PerpOrderHistoryRow[]>;
