 ...
 */
export declare function getPerpLeverageImSurcharge(marginBank: Address, account: Address, client: PublicClient): Promise<bigint>;
/**
 ...
 */
export declare function tryGetPerpLeverageImSurcharge(marginBank: Address, account: Address, client: PublicClient): Promise<bigint | null>;
/**
 ...
 */
export declare function getPerpMaxLeverage(ref: PerpState.PerpPositionRef, opts: GetPerpMaxLeverageOptions, client: PublicClient): Promise<number>;
/**
