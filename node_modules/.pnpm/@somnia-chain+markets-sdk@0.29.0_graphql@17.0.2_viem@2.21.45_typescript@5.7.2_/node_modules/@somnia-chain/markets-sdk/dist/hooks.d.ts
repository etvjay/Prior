...
import type { WatchStatus } from "./liveTail.js";
...
import { type FundingRateSeries } from "./funding.js";
 ...
 * @category React
 */
export declare function SomniaMarketsProvider({ client, children, }: {
 ...
 * @category React
 */
export declare function useSomniaMarketsClient(): SomniaMarketsClient;
/**
 ...
 * @category React
 */
export declare function useWatchMarket(pool: string | undefined): WatchStatus;
/**
 ...
 * @category React
 */
export declare function useWatchUser(user: string | null | undefined): void;
/**
 ...
 * @category React
 */
export declare function useLiveStatus(): TailStatus;
/**
 * True when at least one watch is live (vs idle / hydrating / reconnecting).
 *
 * @category React
 */
export declare function useIsTailing(): boolean;
/**
 * Live trade tape for one pool. Watches the pool while mounted.
 *
 * @category React
 */
export declare function useLiveFills(pool: string | undefined, limit?: number): LiveFill[];
/**
 ...
 * @category React
 */
export declare function useLiveUserFills(pool: string | null, user: string | undefined, limit?: number): LiveFill[];
/**
 * One market by pool address (either kind). Watches the pool while mounted.
 *
 * @category React
 */
export declare function useLiveMarketByPool(pool: string | undefined): LiveMarket | null;
/**
 ...
 * @category React
 */
export declare function useLiveMarketByAddress(addr: string | undefined): BinaryMarket | null;
/**
 * `user`'s orders on one pool. Watches the pool while mounted.
 *
 * @category React
 */
export declare function useLiveUserOrders(pool: string | undefined, user: string | undefined, limit?: number): LiveOrder[];
/**
 ...
 * @category React
 */
export declare function useLiveBinaryOrderBook(pool: string | undefined, depth?: number): BinaryOrderBook;
/**
 ...
 * @category React
 */
export declare function useLiveBinaryOrderBookByMarket(marketId: string | undefined, depth?: number): BinaryOrderBook;
/**
 ...
 * @category React
 */
export declare function useLiveSpotOrderBook(pool: string | undefined, depth?: number): SpotOrderBook;
/**
 ...
 * @category React
 */
export declare function useIndexerQuery<T>(fn: (client: SomniaMarketsClient, signal: AbortSignal) => Promise<T>, deps: readonly unknown[]): IndexerQueryState<T>;
/**
 * A wallet's binary portfolio (indexer read). Re-runs when `account`/`opts` change.
 *
 * @category React
 */
export declare function usePortfolio(account: string | undefined, opts?: PortfolioOptions): IndexerQueryState<Portfolio | undefined>;
/**
 * Markets, newest first (indexer read). Pass `marketType` to narrow.
 *
 * @category React
 */
export declare function useMarkets(opts?: {
 ...
 * @category React
 */
export declare function useCandles(pool: string | undefined, intervalSeconds: number, opts?: {
    limit?: number;
    from?: number;
    to?: number;
 ...
 * @category React
 */
export declare function useLiveFundingUpdates(pool: string | undefined, limit?: number): LiveFundingUpdate[];
/**
 ...
 * @category React
 */
export declare function useFundingRateSeries(pool: string | undefined, intervalSeconds: number, window: {
    from: number;
    to: number;
    limit?: number;
 ...
 * @category React
 */
export declare function useMarketFees(marketId: string | undefined): IndexerQueryState<MarketFees | null | undefined>;
/**
 * Operator directory (indexer read). Pass `owner`/`enabled` to filter, page with `limit`/`offset`.
 *
 * @category React
 */
export declare function useOperators(opts?: OperatorFilter & {
    limit?: number;
    offset?: number;
 ...
 * @category React
 */
export declare function useMarketCreators(opts?: MarketCreatorFilter & {
    limit?: number;
    offset?: number;
 ...
 * @category React
 */
export declare function useOracleAdapters(opts?: {
    owner?: string;
    approved?: boolean;
    limit?: number;
    offset?: number;
 ...
 * @category React
 */
export declare function useLiveMarkets(): LiveMarket[];
/**
 ...
 * @category React
 */
export declare function useWatchPrice(asset: string | undefined): PriceFeedStatus;
/**
 ...
 * @category React
 */
export declare function useLivePrice(asset: string | undefined): LivePrice | null;
/**
 ...
 * @category React
 */
export declare function useLivePriceFeedInfo(asset: string | undefined): PriceFeedInfo | null;
/**
 * The live tick tape of one asset, newest first. Watches the feed while mounted.
 *
 * @category React
 */
export declare function useLivePriceTicks(asset: string | undefined, limit?: number): PricePoint[];
/**
 ...
 * @category React
 */
export declare function useLendReserves(): IndexerQueryState<LendReserve[]>;
/**
 ...
 * @category React
 */
export declare function useLendAccount(account: Address | undefined): IndexerQueryState<LendAccount | undefined>;
