...
export function createClient(config) {
    ...
    const getClients = () => {
        if (!clients)
            clients = Client.makePublicClient(config.chain, resolveWsUrl());
        return clients;
    };
    ...
    const client = {
        ...
        getClosingPrice: (pool) => Orders.getClosingPrice(pool, getClient()),
        ...
        getPerpLeverageImSurcharge: (marginBank, account) => PerpMargin.getPerpLeverageImSurcharge(marginBank, account, getClient()),
        tryGetPerpLeverageImSurcharge: (marginBank, account) => PerpMargin.tryGetPerpLeverageImSurcharge(marginBank, account, getClient()),
        getPerpMaxLeverage: (ref, opts) => PerpMargin.getPerpMaxLeverage(ref, opts ?? {}, getClient()),
        getPerpLinkedWalletRegistry: (marginBank) => PerpLinkedWallet.getPerpLinkedWalletRegistry(marginBank, getClient()),
        quotePerpFundingPayer: (marginBank, account) => PerpLinkedWallet.quotePerpFundingPayer(marginBank, account, getClient()),
        getPerpMainFunding: (marginBank, account) => PerpLinkedWallet.getPerpMainFunding(marginBank, account, getClient()),
        getPerpWalletPullCapacity: (marginBank, wallet) => PerpLinkedWallet.getPerpWalletPullCapacity(marginBank, wallet, getClient()),
        getPerpWalletLinkage: (registry, wallet) => PerpLinkedWallet.getPerpWalletLinkage(registry, wallet, getClient()),
        listPerpLinkedChildren: (registry, main) => PerpLinkedWallet.listPerpLinkedChildren(registry, main, getClient()),
        ...
        getOnchainResolutionPrice: (marketId) => {
            ...
            return Markets.getOnchainResolutionPrice(marketId, { module }, getClient());
        },
