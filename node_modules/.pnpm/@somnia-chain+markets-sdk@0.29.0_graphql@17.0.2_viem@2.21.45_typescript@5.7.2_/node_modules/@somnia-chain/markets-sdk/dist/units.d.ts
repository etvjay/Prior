 ...
 * @category converting
 */
export declare function toHuman(raw: bigint | string, decimals?: number): number;
/**
 ...
 * @category converting
 */
export declare function toHumanString(raw: bigint | string, decimals?: number): string;
/**
 ...
 * @category converting
 */
export declare function fromHuman(human: number | string, decimals?: number): bigint;
/**
 ...
 */
export declare function humanToDecimalString(n: number, decimals: number): string;
/**
 * Raw YES price → YES probability in [0, 1].
 *
 * @category converting
 */
export declare function priceToProbability(rawPrice: bigint | string, decimals?: number): number;
/**
 * YES probability in [0, 1] → raw YES price (the `price` field of placeOrder).
 *
 * @category converting
 */
export declare function probabilityToPrice(probability: number, decimals?: number): bigint;
/**
 ...
 * @category converting
 */
export declare function markYesPrice(top: YesBookTop, lastPrice: bigint | string | null | undefined): bigint | null;
/**
 ...
 * @category converting
 */
export declare function binaryFillsFor(account: string, fills: FillRow[], decimals?: number): BinaryPnlFill[];
/**
 ...
 * @category converting
 */
export declare function binaryFillsFromPortfolio(trades: PortfolioTrade[], decimals?: number): BinaryPnlFill[];
/**
 ...
 * @category converting
 */
export declare function computeBinaryPnl(fills: BinaryPnlFill[], balances: OutcomeBalances, market: Pick<BinaryMarket, "quoteDecimals" | "lastPrice" | "winningOutcome" | "voided">, opts?: {
 ...
 * @category converting
 */
export declare function balanceFloor(raw: bigint, decimals?: number): number;
/**
 ...
 * @category converting
 */
export declare function floorRawBalance(raw: bigint, decimals: number, quantum: string): number;
/**
 ...
 * @category converting
 */
export declare function ceilRawAmount(raw: bigint, decimals: number, quantum: string): bigint;
/**
 ...
 * @category converting
 */
export declare function upProbability(rawYes: bigint | string | null | undefined, decimals: number | undefined): number | null;
/**
 * The Up probability as a whole-percent integer (e.g. `0.546` → `55`).
 *
 * @category converting
 */
export declare function upPercent(rawYes: bigint | string | null | undefined, decimals: number | undefined): number | null;
