 ...
 * @category networks
 */
export declare const somniaChains: {
    readonly 5031: {
        blockExplorers: {
            readonly default: {
    ...
    readonly 50383: {
        ...
        contracts: {
            readonly multicall3: {
                readonly address: "0x540B091b608f54E603c5dC19F6b2d955e1d2D131";
                readonly blockCreated: 265712387;
            };
        };
        ensTlds?: readonly string[] | undefined;
        id: 50383;
 ...
 * @category networks
 */
export declare function getSomniaChain(chainId: number): Chain | null;
/**
 ...
 * @category networks
 */
export declare function isSomniaChainId(chainId: number): chainId is ChainId;
