...
function onMarketCreated(ev, store) {
    ...
    const market = {
        ...
        status: ev.timestampSec >= tradingStart && ev.timestampSec < expiry
            ? "Trading"
...
function onPoolReleased(ev, store) {
    ...
    if (store.poolToMarket.get(pool) === id)
