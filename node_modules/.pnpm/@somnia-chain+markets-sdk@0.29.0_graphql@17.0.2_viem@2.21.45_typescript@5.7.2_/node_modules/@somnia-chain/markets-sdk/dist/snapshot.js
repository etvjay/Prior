 ...
 */
export async function loadMarketsSnapshot(chainId, scope, deps) {
    ...
    const markets = Markets.toMarkets(data.Market);
 ...
 */
export async function loadUserSnapshot(chainId, user, deps) {
