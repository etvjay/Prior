...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    try {
      ...
      if (url.pathname === "/v1/capabilities") return json({ ...service.capabilities(context), scopes: ["prior:read"], routes: ["GET /health", "GET /v1/capabilities", "GET /v1/circuits/:id", "GET /v1/markets/:marketId", "GET /v1/forecasts/:id"], hosted: { mode: "SHANNON_RPC_READ_ONLY", canonicalState: "SHANNON_RPC_READ_VERIFIED_FOR_BOUND_DETAILS", submission: "DISABLED", execution: "DISABLED", persistence: "NONE", listIndexing: "NOT_CONNECTED", evidenceMode: "SHANNON_RPC_READ_ONLY" } });
